...
down_revision 演进：初版 20260904223000（提交者本地链，文件一度未随 d4fdcc7a
入库）→ 20260903170000（eb163076 临时改接修 KeyError crash-loop）→ 20260904223000
（本版终局：ec98f91a 补提交该文件后双头分叉，恢复线性链 03170000→04223000→
05004300 消除双 head；已部署库 stamp 在 20260905004300 视新祖先为已应用不重跑，
其缺列已按同 DDL 手动补齐，无 DuplicateColumn 风险）。downgrade 对称删索引+删表。
