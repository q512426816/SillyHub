  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end bg-black/40" onClick={onClose}>
      <aside
        ...
        className="flex h-full w-full max-w-xl flex-col gap-4 overflow-y-auto bg-background p-6 shadow-xl"
        onClick={(e) => e.stopPropagation()}
      >
        <header className="flex items-start justify-between gap-3">
          <div>
            <h2 id="component-detail-title" className="text-lg font-semibold">
              {component.name}
            </h2>
        ...
        <section className="grid grid-cols-[7rem_1fr] gap-y-2 text-xs">
          {component.type && (
            <>
        ...
        <section className="space-y-2">
          <h3 className="text-sm font-medium">关联</h3>
        ...
        {Object.keys(component.extra).length > 0 && (
          <section className="space-y-2">
            <h3 className="text-sm font-medium">未识别字段（extra）</h3>
            <pre className="rounded-md bg-muted p-3 font-mono text-xs">
