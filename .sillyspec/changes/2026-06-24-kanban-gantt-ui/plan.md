...
- [ ] task-01: 新增 `_components/kanban-gantt-helpers.ts`
...
- [ ] task-02: 新增 `_components/kanban-gantt-helpers.test.ts`
...
- [ ] task-03: 新增 `_components/kanban-gantt.tsx`(计划甘特)
...
- [ ] task-04: 新增 `_components/kanban-actual-gantt.tsx`(实际甘特)
...
- [ ] task-07: `lib/ppm/kanban-grouping.ts` 去留
