...
- `backend/app/modules/daemon/session/service/compact.py` <!--TODO: 归属判定-->
...
- `sillyhub-daemon/tests/interactive/session-compact.test.ts` <!--TODO: 归属判定-->
...
- `backend/app/modules/daemon/tests/test_session_compact_endpoint.py` <!--TODO: 归属判定-->
