...
- `backend/migrations/versions/20260910120000_add_auto_resume_origin_and_run_metadata.py` <!--TODO: 归属判定-->
- `backend/app/modules/daemon/session/service/auto_resume.py` <!--TODO: 归属判定-->
- `backend/app/modules/daemon/session/service/recovery.py` <!--TODO: 归属判定-->
- `backend/app/modules/daemon/session/service/queue.py` <!--TODO: 归属判定-->
- `backend/app/modules/daemon/session/service/inject.py` <!--TODO: 归属判定-->
...
- `backend/app/modules/daemon/session/service/session_lifecycle.py` <!--TODO: 归属判定-->
...
- `frontend/src/components/agent-log/run-error-item.tsx` <!--TODO: 归属判定-->
...
- `backend/app/modules/daemon/tests/test_auto_resume_integration.py` <!--TODO: 归属判定-->
