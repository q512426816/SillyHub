...
| 2026-08-11 | 2026-08-11-agent-profile-bind-llm-provider | api-types.ts 重生成加 `llm_provider_id`（AgentProfileAggregatedItem/AgentProfileCreate/AgentProfileRead/AgentProfileUpdate），gen:types:check 绿（NFR-04） |
